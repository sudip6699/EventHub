...
<nav class="glass-nav sticky top-0 z-50 border-b border-outline-variant/20 shadow-sm">
    <div class="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-6">
            ...
            <a href="${pageContext.request.contextPath}/about" class="text-sm font-semibold text-on-surface-variant hover:text-primary transition-colors">
                <span class="flex items-center gap-1"><span class="material-symbols-outlined text-lg">info</span> About</span>
            </a>

            <a href="${pageContext.request.contextPath}/contact" class="text-sm font-semibold text-on-surface-variant hover:text-primary transition-colors">
                <span class="flex items-center gap-1"><span class="material-symbols-outlined text-lg">mail</span> Contact</span>
            </a>
            <% if (navIsAdmin) { %>
